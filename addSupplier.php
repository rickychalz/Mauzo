            ...
            <div class="container-fluid px-[0.625rem]">
                ...
                <div class="grid grid-cols-1 mb-5">
                    <div class="flex items-center justify-between">
                        <h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">Add Supplier</h4>
                    ...
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <form action="" method="POST">
                            <div class="card-body pb-0">
                                <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100">Supplier Details</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        <div class="mb-4">
                                            <label for="example-text-input"
                                                class="block font-medium text-gray-700 dark:text-gray-100 mb-2">Supplier
                                                Name</label>
                                            <input
                                                ...
                                                type="text" placeholder="Enter supplier name" id="example-text-input" name="supplierName">
                                        </div>
                                        <div class="mb-4">
                                            <label for="example-text-input"
                                            ...
                                            <input
                                                class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100 dark:text-zinc-100"
                                                type="tel" placeholder="Enter phone number" id="example-text-input" name="supplierPhone">
                                        </div>
                                    </div>
                                    <div class="col-span-12 lg:col-span-6">
                                        <div class="mb-4">
                                            ...
                                            <input
                                                ...
                                                type="email" placeholder="johndoe@example.com" id="example-email-input" name="supplierEmail">
                                        </div>
                                        <div class="mb-4">
                                            <label for="example-text-input"
                                            ...
                                            <input
                                                class="w-full rounded border-gray-100 py-2.5 text-sm text-gray-500 focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-zinc-100"
                                                type="text" placeholder="Enter address" id="example-email-input" name="supplierAddress">
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-6">
                                    <button type="submit"
                                        class="btn bg-violet-500 border-transparent text-white font-medium w-28 hover:bg-violet-700 focus:bg-violet-700 focus:ring focus:ring-violet-50" name="addSupplier">Add
                                        </button>
                                </div>
                            </div>
                        </form>
