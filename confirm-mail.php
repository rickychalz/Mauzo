...
<head>
    <meta charset="utf-8" />
    <title>Confirm Mail - Mauzo</title>
    <meta
      name="viewport"
                            ...
                            <div class="flex h-[90vh] flex-col">
                                ...
                                <div class="my-auto">
                                    ...
                                    <div class="text-center mt-6">
                                        ...
                                        <p class="text-gray-500 mt-1">Your Account has been verified. You can login to continue!</p>
                                    </div>

                                    <div class="mt-5 flex flex-row justify-center">
                                        <a href="index.php" class="btn border-transparent bg-violet-500 w-48 py-2.5 text-white shadow-md shadow-violet-200 dark:shadow-zinc-600">Back to Login</a>
                                    </div>
                                </div>
