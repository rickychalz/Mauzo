...
<html lang="en" dir="ltr">
    ...
    <head>
        <meta charset="utf-8" />
        <title>404 error - Mauzo</title>
        <meta
          name="viewport"
          content="width=device-width, initial-scale=1, shrink-to-fit=no"
        />
        <meta
          content="Sales and Inventory Management"
          name="description"
        />
                            ...
                            <div class="grid grid-cols-12 justify-center pt-12">
                                <div class="col-span-12">
                                    ...
                                    <div class="mt-12 text-center">
                                        <a class="btn bg-violet-500 border-transparent focus:ring focus:ring-violet-50 py-2 text-white" href="dashboard.php">Back to Dashboard</a>
                                    </div>
                                </div>
