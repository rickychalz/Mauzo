...
<?php include('./includes/resetEmail.php') ?>
                        ...
                        <div class="flex h-[90vh] flex-col">
                            ...
                            <div class="my-auto mx-auto">
                                <div class="text-center mb-4">
                                    ...
                                    <p class="text-gray-500 mt-1 dark:text-zinc-100/60">Enter your Email to reset your password</p>
                                </div>
                                <?php
            ...
            <p>$successMessage</p>
                                ...
                                <form class="mt-4 pt-2" action="" method="POST">
                                    <div class="mb-6">
                                        ...
                                        <input type="text" class="w-full border-gray-100 rounded placeholder:text-sm py-2 placeholder:text-gray-400 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-gray-100 dark:placeholder:text-zinc-100/60" id="email" placeholder="Enter email" name="email">

                                    </div>

                                    <div class="mb-4 flex flex-row justify-center">
                                        <button class="btn border-transparent bg-violet-500 w-48 py-2.5 text-white w-100 waves-effect waves-light shadow-md shadow-violet-200 dark:shadow-zinc-600" type="submit" name="reset">Reset</button>
                                    </div>
                                </form>

                                <div class="mt-12 text-center">
                                    <p class="text-gray-500 dark:text-zinc-100">Remember It ? <a href="index.php" class="text-violet-500 font-semibold"> Login </a> </p>
                                </div>
                            </div>
