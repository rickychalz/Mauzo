...
<head>
    <meta charset="utf-8" />
    <title>Email Verification - Mauzo</title>
    <meta
      name="viewport"
                            ...
                            <div class="flex h-[90vh] flex-col">
                                ...
                                <div class="my-auto">
                                    ...
                                    <div class="text-center mt-6">
                                        ...
                                        <p class="text-gray-500 mt-1 dark:text-zinc-100/60">We have sent you verification email example@abc.com, Please check it</p>
                                    </div>

                                    <div class="mt-5 text-center">
                                        <a href="auth-login.html" class="btn border-transparent bg-violet-500 py-2.5 text-white shadow-md shadow-violet-200 dark:shadow-zinc-600">Verify email</a>
                                    </div>

                                    <div class="mt-10 text-center">
                                        <p class="text-gray-500 mb-0 dark:text-zinc-100">Didn't receive an email ? <a href="#" class="text-primary font-semibold"> Resend </a> </p>
                                    </div>
                                </div>

                                
                                <div class=" text-center">
                                    <p class="text-gray-500 relative mb-5 dark:text-zinc-100">© <script>document.write(new Date().getFullYear())</script> Mauzo <!--Crafted with <i class="mdi mdi-heart text-red-400"></i> by Themesbrand</p>-->
                                </div>
                            </div>
                        </div>
                    </div>
