            ...
            <div class="container-fluid px-[0.625rem]">
                ...
                <div class="grid grid-cols-1 mb-5">
                    <div class="flex items-center justify-between">
                        <h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">Add Category</h4>
                    ...
                    <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                        <form action="" method="POST">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-span-12 lg:col-span-6">
                                        <div class="mb-4">
                                            <label for="example-text-input"
                                                class="block font-medium text-gray-700 dark:text-gray-100 mb-2">Category
                                                Name</label>
                                            <input
                                                ...
                                                type="text" placeholder="Enter category name" id="categoryName" name="categoryName">
                                        </div>
                                ...
                                <div class="mt-6">
                                    <button type="submit"
                                        class="btn bg-violet-500 border-transparent text-white font-medium w-28 hover:bg-violet-700 focus:bg-violet-700 focus:ring focus:ring-violet-50" name="addCategory">Add
                                        </button>
                                </div>
                            </div>
                        </form>
