...
$thisWeekQuery = "SELECT SUM(discount) AS this_week_sum FROM Sales WHERE `date` BETWEEN '$thisWeekStart' AND '$today'";
...
$lastWeekQuery = "SELECT SUM(discount) AS last_week_sum FROM Sales WHERE `date` BETWEEN '$lastWeekStart' AND '$thisWeekStart'";
